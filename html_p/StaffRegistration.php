...
<?php
        ...
        if(isset($_POST['submit'])){
		  ...
		  $sub=$_POST['subject'];
				...
				$sql="INSERT INTO stafflogin VALUES('$staffid','$name','$department','$sem','$sub')";
                ...
                <form class="form-horizontal" action="#" method="post" name="r1">
					...
					<div class="form-group">
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-10">          
						  <input type="text" class="form-control" name="semester" placeholder="Enter ongoing Semester/s of teaching">
						</div>
					  </div>
					  <div class="form-group">
						<label class="control-label col-sm-2" >Subject:</label>
						<div class="col-sm-10">          
						  <input type="text" class="form-control" name="subject" placeholder="Enter Subject of Teaching">
						</div>
					  </div>
